...
export const translations: Record<string, Translations> = {
  en: {
    ...
    hero: {
      badge: "AI-Powered Media Authenticity Verification",
      heading1: "Verify Manipulated Images.",
      heading2: "Protect Your Digital Identity.",
      body: "Multi-layer forensic analysis to detect deepfakes and image tampering. Generate cryptographic evidence reports for legal takedown and platform abuse filings.",
      ctaPrimary: "Create Verification Case",
      ctaSecondary: "Protect Your Images",
      trust1: "Private by default",
      trust2: "Anonymous reporting",
      trust3: "No account required",
      stat1Label: "Detection accuracy",
      stat2Label: "Mean analysis time",
      stat3Label: "Cryptographic hashing",
    },
    howItWorks: {
